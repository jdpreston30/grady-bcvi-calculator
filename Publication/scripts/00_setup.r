...
#+ 0.4: Load configuration and detect computer/data paths
# For external users: specify custom path like load_config_and_paths("/your/data/path")
config <- load_config_and_paths()
#+ 0.5: Resolve conflicts
