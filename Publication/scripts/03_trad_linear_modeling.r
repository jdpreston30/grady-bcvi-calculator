...
#+ 3.0 Ensure data is randomized up front, reproducibly
descriptive_data_imputed_shuffled <- shuffle_rows_by_id(descriptive_data_imputed, id_col = "ID", seed = 2025)
#+ 3.1: Add a context variable for the model
modeling <- descriptive_data_imputed_shuffled %>%
  mutate(
...
#- 3.3.3: Now we will test the performance of each of these without weighting
...
#- 3.3.4: Now we will test the performance of each of these with weighting
